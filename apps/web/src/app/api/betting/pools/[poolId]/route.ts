...
// Pool details are semi-static — revalidate every 30 s on the CDN edge
 ...
 *
 * Optimisations:
 * - 30 s in-memory cache to avoid repeated DB hits for the same pool
 * - CDN stale-while-revalidate for edge caching
 */
